...
import { LayoutDashboard, Ticket, User, LogOut, Menu, X, PoundSterling } from 'lucide-react';
      ...
      <div className="px-6 pt-7 pb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-semibold tracking-[0.15em] uppercase mt-0.5" style={{ color: 'var(--gold)', opacity: 0.7 }}>Tenant Portal</p>
          </div>
        </div>
      </div>
